...
if strcmp(type,'runica')
    [laplaceEst, threshEst, quantileEst] = epi_latent_dims(EEG.data);
    [OUTEEG, com] = pop_runica(EEG, 'extended',1,'interupt','on','pca', laplaceEst); %runica for parametric, default extended for finding subgaussian distributions
